...
app.controller('duplicateCtrl', function($scope,$http,$routeParams,$location, getHighDollerService) {
    $scope.loading = true;
    ...
    getHighDollerService.getData('Duplicate').then(function(response){
