app.controller('highmileageCtrl', function($scope,$http,$routeParams,$location,getHighDollerService) {
  $scope.loading = true;
  ...
  getHighDollerService.getData('High Mileage').then(function(response){
