app.controller('suspiciousKeywordsCtrl', function($scope,$http,$routeParams,$location,getHighDollerService) {
  $scope.loading = true;
  ...
  getHighDollerService.getData('Suspicious Keywords').then(function(response){
