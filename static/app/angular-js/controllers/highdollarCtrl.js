app.controller('highdollarCtrl', function($scope,$http,$routeParams,$location,getHighDollerService) {
  $scope.loading = true;
  ...
  getHighDollerService.getData('High Dollar').then(function(response){
