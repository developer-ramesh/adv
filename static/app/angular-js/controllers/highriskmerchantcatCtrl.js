app.controller('highriskmerchantcatCtrl', function($scope,$http,$routeParams,$location,getHighDollerService) {
  $scope.loading = true;
  ...
  getHighDollerService.getData('High Risk Merchant Categories').then(function(response){
