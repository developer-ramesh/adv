app.controller('excessiveHighRiskExpenseCtrl', function($scope,$http,$routeParams,$location,getHighDollerService) {
  $scope.loading = true;
  ...
  getHighDollerService.getData('Excessive High Risk Expense Categories').then(function(response){
