app.controller('dailymealsCtrl', function($scope,$http,$routeParams,$location,getHighDollerService) {
  $scope.loading = true;
  ...
  getHighDollerService.getData('Daily Meals Over Threshold').then(function(response){
